...
function addTodoItem() {
  ...
  // Pastikan pemanggilan fungsi `renderTodoList` ada di paling akhir
  // dari fungsi ini.
  renderTodoList();
}
...
// 3. Implementasikan fungsi renderTodoList
...
function renderTodoList() {
  ...
  todoList.forEach((todo, index) => {
    todoListElement.appendChild(createTodoItemElement(todo, index));
  });
}
